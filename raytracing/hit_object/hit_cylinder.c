...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2026/04/12 22:10:09 by ebichan           #+#    #+#             */
/*   Updated: 2026/04/13 01:06:16 by ebichan          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_hit hit_cylinder(t_ray ray, t_cylinder *cylinder)
{
    ...
    if(side > 0.0 && check_height(ray, cylinder, side))
        hit = make_hit(ray, cylinder->color, side, get_side_normal(ray_at(ray, side), cylinder));
