...
/*   Updated: 2026/04/13 18:30:56 by yebi             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "minirt.h"

static bool	set_plane(t_elem *elem, t_point point, t_vector vector,
		t_color color)
{
	t_plane	*new_node;
	t_plane	*last;
...
static bool	set_cylinder(t_elem *elem, t_point point, t_vector vector,
		t_cylen len, t_color color)
{
	t_cylinder	*new_node;
	t_cylinder	*last;
