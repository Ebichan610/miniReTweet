...
t_point apply_point(char *str)
{
    ...
    if(!in_double_range(strs[0], DOUBLE_ALL) || !in_double_range(strs[0], DOUBLE_ALL) || !in_double_range(strs[0], DOUBLE_ALL))
    {
        free_strs(strs);
        return(point);
    }
...
t_vector apply_vector(char *str)
{
    ...
    if(!in_vector_range(strs[0]) || !in_vector_range(strs[0]) || !in_vector_range(strs[0]))
    {
        free_strs(strs);
        return(vector);
    }
...
t_color apply_color(char *str)
{
    ...
    if(!in_color_range(strs[0]) || !in_color_range(strs[1]) || !in_color_range(strs[2]))
    {
        free_strs(strs);
        return(color);
    }
